...
public class DownloadManager extends JFrame implements Observer {
	...
	private static final long serialVersionUID = 9042065034817243414L;
	...
	// Currently selected downloaded
	private Download downloaded_ = null;

	// Flag for whether or not table selection is being cleared.
	private boolean clearing;

	// Constructor for Download Manager.
	public DownloadManager(final String url) {
		...
		addTextField.setText(url == null ? "" : url);
	...
	public Download getDownloaded_() {
		return downloaded_;
	}
	...
	private boolean actionUpdate() {
		...
		if (verifiedUrl != null) {
			downloaded_ = new Download(verifiedUrl);
			tableModel.addDownload(downloaded_);
	...
	public static void showDownload(final String url) {
		try {
